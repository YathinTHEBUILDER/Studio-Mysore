...
export const WhatsAppCTA: React.FC<WhatsAppCTAProps> = ({
  ...
  return (
    <a
      ...
      onClick={onClick}
      className={cn(
        "group inline-flex items-center justify-center gap-2.5 h-[56px] px-[28px] rounded-[999px] bg-[#FFFFFF] text-[#000000] font-['Inter',var(--font-inter),sans-serif] text-[15px] font-medium leading-none transition-[transform,background-color,color] duration-200 ease-out hover:scale-[1.03] outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 shrink-0 select-none",
        className
      )}
