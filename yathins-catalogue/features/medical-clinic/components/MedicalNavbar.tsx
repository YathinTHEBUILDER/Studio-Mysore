...
export const MedicalNavbar: React.FC<MedicalNavbarProps> = ({ onOpenBooking }) => {
  return (
    <header className="sticky top-0 z-40 w-full bg-zinc-950/90 backdrop-blur-xl border-b border-teal-900/20 py-4">
      <Container variant="wide" className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <span className="text-[10px] font-mono text-teal-400/80 tracking-wider uppercase block">
                Multi-Specialty Clinic • Instant Telehealth
              </span>
            </div>
          </div>
        </div>
        ...
        <button
          ...
          className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-teal-600 hover:bg-teal-500 text-white font-semibold text-xs tracking-wide transition-all active:scale-95 shadow-lg shadow-teal-600/20"
        >
