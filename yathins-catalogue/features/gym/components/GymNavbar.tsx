...
export const GymNavbar: React.FC<GymNavbarProps> = ({ onOpenTrial }) => {
  return (
    <header className="sticky top-0 z-40 w-full bg-zinc-950/90 backdrop-blur-xl border-b border-indigo-900/20 py-4">
      <Container variant="wide" className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <span className="text-[10px] font-mono text-indigo-400/80 tracking-wider uppercase block">
                Boutique HIIT & Strength • Turnstile QR Access
              </span>
            </div>
          </div>
        </div>
        ...
        <button
          onClick={onOpenTrial}
          className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-semibold text-xs tracking-wide transition-all active:scale-95 shadow-lg shadow-indigo-600/20"
        >
